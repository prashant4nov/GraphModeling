...
consumer_key="XYF0V608bI5xmllxZuxtayPar"
consumer_secret="WIeXHr69hm8bDYflybFmCJEZGzQD9PbiaEOdWF7M8ONl7uBkNf"
access_token="1233464466-NpTPhscTpE8S3q3i5E33rOnFi2cpb3dy5FYILYe"
access_token_secret="DLV5S5alKbmC2pFyrK7rFeZZNtMRINAa0OtdVK2GjlZQS"
...
def readPosted(self):
  print 'read posted'
  query = 'MATCH (a)-[:`POSTED`]->(b) RETURN a,b LIMIT 5'
  results = neo4j.CypherQuery(graph_db, query).run()
